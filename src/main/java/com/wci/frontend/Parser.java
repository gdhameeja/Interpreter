 ...
 * <h1>Parser </h1>
 *
 * <p>A language independent class. The implementation will be provided by langage specific
 * subclasses.
 */
public abstract class Parser implements MessageProducer {
  ...
  /**
   * Parse a source program to generate Intermediate Code and symbol table. To be implemented by
   * language specific subclass. Throws exception on error.
   */
  public abstract void parse() throws Exception;

  /**
   * Return number of syntax errors found by the parser. To be implemented by language specific
   * subclasses. Throws exception on error.
   */
