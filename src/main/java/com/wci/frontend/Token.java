 ...
 * <h1>Token </h1>
 *
 * <p>The framework class that represetns a token returned by scanner.
 */
public class Token {
  ...
  /**
   * Default method to extract only one-character tokens from the source. Subclasses can override
   * this method to construct lanugage-specific tokens. After extracting the token the current, the
   * current source line will be one beyond the last token character.
   *
