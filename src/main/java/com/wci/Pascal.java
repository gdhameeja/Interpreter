 ...
 * <h1>Pascal </h1>
 *
 * <p>Compile or interpret a Pascal source program.
 */
public class Pascal {
   ...
   * The main method.
   *
   * @param args The command-line arguements: "compile" or "execute" followed by optional flags
        ...
        case SOURCE_LINE:
          {
            ...
            System.out.printf(String.format(SOURCE_LINE_FORMAT, lineNumber, lineText));
            break;
          }
      }
    }
        ...
        case SYNTAX_ERROR:
          {
            ...
            int spaceCount = PREFIX_WIDTH + positon;
            StringBuilder flagBuffer = new StringBuilder();

            // Spaces up to the error position.
            for (int i = 1; i < PREFIX_WIDTH; i++) {
              flagBuffer.append(' ');
            }

            // A pointer to the error followed by flag messages.
            flagBuffer.append("^\n*** ").append(errorMessage);
